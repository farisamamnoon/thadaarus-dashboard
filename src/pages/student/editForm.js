...
const StudentEdit = () => {
  ...
  const {
    ...
    queryKey: ["formData"],
    queryFn: async () => await fetchData(`student/${studentId}`),
  });
  ...
  const dob = formatStringToDate(dobString);
    ...
    <>
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            const response = await axios.put(`${base_url}/student/${studentId}/edit`, values);
